		...
		.then((dataUrl) => {
			domtoimage
				...
				.then((dataUrl2) => {
					var img = new Image();
					img.src = dataUrl2;
					downloadURI(dataUrl2, 'Riverfield-Laboratory-ID.png');
